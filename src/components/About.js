            ...
            <div id="aboutDesktop">
                ...
                <div className="about">
                    ...
                    <Fade bottom when={showContent}>
                        ...
                        <p>When I’m not building a site, I’m typically watching, listening to podcasts about, and reading/writing about movies. You can read my short movie reviews and more about my experience at Lambda School on my blog in the “contact” section. Looking forward to hearing from you! </p>
                        </div>
                    </Fade>
                </div>
            </div>
